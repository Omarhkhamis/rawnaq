...
export function MediaPickerField({
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-[120] flex items-start justify-center bg-black/70 px-4 py-6">
          <div className="panel flex max-h-[calc(100vh-3rem)] w-full max-w-5xl flex-col overflow-hidden px-5 py-5 md:px-6">
            ...
            <div className="mt-5 flex-1 overflow-y-auto pr-1">
              <div className="grid gap-3 rounded-[1.5rem] border border-line/60 bg-black/15 p-4 md:grid-cols-[1fr_auto]">
                <input
